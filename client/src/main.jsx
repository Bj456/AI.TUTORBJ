...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { element: <DashboardLayout />, children: [
          ...
          { path: "/dashboard/flashcards", element: <FlashCard /> },
          { path: "/dashboard/EbookLibrary/ebooks", element: <EBooksPage /> },
          { path: "/dashboard/OpenLibraries", element: <OpenLibraries /> },
          { path: "/dashboard/EbookLibrary", element: <EbookLibrary /> },
      ]}
    ]
  }
]);
